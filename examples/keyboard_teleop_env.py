...
class Runner:
    def __init__(self, args):
        ...
        self.env = gym.make(args.env, render_mode="human", action_mode="ee", observation_mode="state")
    ...
    def run(self):
        ...
        while True:
            ...
            observation, reward, terminted, truncated, info = self.env.step(self.action)
            self.env.render()
